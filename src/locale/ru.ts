export const TRANSLATIONS_RU = {
  ...
  "wipeOutMyUser.warningBody": "Это действие <strong>навсегда и безвозвратно</strong> удалит ваш аккаунт и все связанные с ним неигровые данные, включая личные сообщения, настройки и персональную информацию.",
  "wipeOutMyUser.warningNoUndo": "<strong>Это нельзя отменить.</strong> После удаления аккаунт восстановить невозможно.",
  "wipeOutMyUser.anonymizationNote": "В соответствии с нашей политикой конфиденциальности игровые материалы — посты, анкеты персонажей и заявки на розыск — удалены не будут, но будут <strong>обезличены</strong>: все связи с вашим аккаунтом будут удалены.",
  "wipeOutMyUser.gdprNote": "Эта функция предоставлена в соответствии с <strong>Общим регламентом по защите данных (GDPR)</strong>, который гарантирует вам право на удаление («право быть забытым»).",
  ...
  "wipeOutMyUser.confirmBody": "Ваш аккаунт и все неигровые персональные данные будут <strong>навсегда удалены</strong>. Это действие <strong>необратимо</strong>.",
